                ...
                If Sequence = 1 Then
                    ...
                    Select Case Val(TransType)
                        Case 0
                            ...
                            Dim ForSale As Double = (New mymastercoinsold).GetCurrencyForSale(SenderID, CurrencyID, BlockNumber)
                            Dim Pending As Double = (New mymastercoinsold).GetSellerCoinsPendingPayment(SenderID, BlockNumber)
            ...
            If IsPayment Then
                ...
                If DSTest.Tables(0).DefaultView.Count > 0 Then
                    ...
                    For Each subitem In OutArray
                        If Not subitem("address") Is Nothing Then
                            If subitem("address").ToString <> "1EXoDusjGwvnjZUyKkxZ4UHEf77z6A5S4P" Then
                                ...
                                End If
                                'Else It's an Exodus address transaction
                            End If
                        Else
                            '    Remarks = "Check if Payment Transaction:  No Address"
                            Remarks = "Check if Payment Transaction:  No Address MultiSig"
                        End If
                    Next
                Else
...
" and MaxBlockNo>=" + BlockNumber.ToString
    ...
    Function GetCurrencyForSale(ByVal AddressID As Integer, ByVal CurrencyID As Integer, ByVal CurrentBlockNo As Integer) As Double
        ...
        If DSAvailable.Tables(0).DefaultView.Count > 0 Then
            Available = DSAvailable.Tables(0).Rows(0).Item("Available")
        End If
        Return Available
    End Function
    ...
    Function GetExodusTrans(ByRef ProgressBar1 As ProgressBar) As String
        ...
        If Not lError Then
            ...
            For Each item As JProperty In results
                ...
                If Not (New mymastercoinsold).IsTxIDinExodus(hash) Then
                    '                   Message = " " + hash
